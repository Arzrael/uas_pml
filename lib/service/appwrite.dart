...
class AppwriteService {
  ...
  AppwriteService() {
    client
      ...
      ..setProject("677ce47e0039b2f5540c"); // Project ID Appwrite Anda
  ...
  Future<void> createPost(String title, String body, String user,
    ...
    try {
      ...
      if (imagePath != null) {
        ...
        imageUrl =
            'https://cloud.appwrite.io/v1/storage/buckets/${responseImg.bucketId}/files/${responseImg.$id}/view?project=677ce47e0039b2f5540c&mode=admin';
